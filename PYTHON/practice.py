...
#         def isSymetricTree(left , right):
#             if left is None and right is None:
#                 return True
#             if left is None or right is None:
#                 return False
#             return (left.data == right.data) and isSymetricTree(left.left , right.right) and isSymetricTree(left.right , right.left)
...
# unique = set()
# duplicates = set([x for x in arr if x in unique or unique.add(x)])
...
# def binary_search_duplicates(sorted_lst):
#     duplicates = []
#     n = len(sorted_lst)
...
#         if sorted_lst[mid] == sorted_lst[low]:
#             duplicates.append(sorted_lst[low])
#             break
#         elif sorted_lst[mid] < sorted_lst[low]:
#             low = mid + 1
#         else:
#             high = mid - 1
...
# # Find duplicates using binary search method
# duplicates = binary_search_duplicates(lst)
